    ...
    <div class="row">
      <div class="d-flex justify-content">
        ...
        <div class="col-6 d-flex justify-content-end align-items-center">
          <button class="btn btn-primary mr-3" @click="incluirTipoServico()">Incluir Tipo de Serviço</button>
        </div>
      </div>
    </div>
    <hr>

    <getTipoServico ref="componentGetTipoServico"></getTipoServico>
      ...
      <div class="modal-content">
        ...
        <form id="modalForm" class="row" @submit.prevent="enviarFormulario()">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="descricao" name="descricao" required v-model="formData.descricao" placeholder="Ex... Remoção"><br>
          </div>
...
import getTipoServico from '../components/tipoServico/getTipoServico.vue';
...
export default {
  ...
  setup() {
    ...
    onMounted(async () => {
      try {
        const response = await axios.get('https://localhost:7255/api/TipoServico/TipoServicos/'+localStorage.getItem('gerenteId'), {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
          }
        });
        tipoServicos.value = response.data;
      } catch (error) {
  ...
  methods: {
    ...
    enviarFormulario() {
      ...
      axios.post('https://localhost:7255/api/TipoServico', this.formData, {
        headers: {
        ...
        .then(response => {
          ...
          this.$refs.componentGetTipoServico.getTipoServico();
