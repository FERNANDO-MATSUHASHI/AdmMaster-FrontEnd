  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <!-- Ícone de excluir -->
        <i class="fi-rr-trash" @click="excluirColaborador(id)"></i>
      </td>
    </tr>
  </tbody>
...
export default {
  ...
  methods: {
    ...
    editarColaborador() {
      // Lógica para editar o colaborador com o ID fornecido
      // Montar o forDataPut
      ...
      // console.log('Cargo', this.cargoId);
      // Abre Modal Editar
      this.editarModal = true;
      // console.log('Editar colaborador com ID:', id, this.nome);
    },
    // Método para excluir um colaborador
    excluirColaborador(id) {
      // Lógica para excluir o colaborador com o ID fornecido
      console.log('Excluir colaborador com ID:', id);
    },
    editarFormulario() {
      // console.log('Data Original: ', this.data_nascimento);
